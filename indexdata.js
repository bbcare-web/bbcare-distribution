var indexdata = 
[
    { text: '字典菜单',isexpand:false, children: [ 
		{url:"html/dictorManger/treeedit.htm",text:"菜单管理" },
		{url:"demos/base/drag.htm",text:"拖动"},
	]
    },
    { text: '系统菜单', isexpand: false, children: [
		{ url: "html/systemManager/systemEdit.htm", text: "系统管理" },
		{ url: "html/systemManager/treeedit.htm", text: "菜单查看" },
		{ url: "html/systemManager/treeedit.htm", text: "菜单编辑" } 
	]
    }, 
